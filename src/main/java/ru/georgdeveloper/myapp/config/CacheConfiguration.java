...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, ru.georgdeveloper.myapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, ru.georgdeveloper.myapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
