...
import static ru.georgdeveloper.myapp.domain.EmployeeAsserts.*;
...
class EmployeeResourceIT {
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).phoneNumber(UPDATED_PHONE_NUMBER);
